...
---
## Índice
- [Manipulação de Dados e Objetos com .NET](#manipula-o-de-dados-e-objetos-com-net)
  * [Índice](#-ndice)
  ...
  * [Nuget, Serializar e Atributos](#nuget-serializar-e-atributos)
    ...
    + [Serialização](#serializa-o)
      ...
      - [[JSON Viewer](https://codebeautify.org/jsonviewer)](#-json-viewer-https-codebeautifyorg-jsonviewer)
