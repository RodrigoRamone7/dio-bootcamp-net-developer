...
- [Manipulação de Dados e Objetos com .NET](#manipulação-de-dados-e-objetos-com-net)
   * [Propriedades](#propriedades)
      ...
      + [Validações GET e SET](#validações-get-e-set)
         - [Criando uma validação](#criando-uma-validação)
         - [Validação GET](#validação-get)
         - [Validação SET](#validação-set)
   ...
   * [Métodos](#métodos)
      ...
      + [Tipos de retorno](#tipos-de-retorno)
         ...
         - [Método com retorno](#método-com-retorno)
   ...
   * [Manipulando valores](#manipulando-valores)
      ...
      + [Formatando valores monetários](#formatando-valores-monetários)
         - [Formatação monetária de outra região](#formatação-monetária-de-outra-região)
      + [Formatação personalizada](#formatação-personalizada)
         - [Formatando casas decimais](#formatando-casas-decimais)
         - [Formatando porcentagem](#formatando-porcentagem)
      + [Formatação do tipo DateTime](#formatação-do-tipo-datetime)
         - [Formatando data e hora](#formatando-data-e-hora)
         - [Somente data ou hora](#somente-data-ou-hora)
         - [Conversões no DateTime](#conversões-no-datetime)
            * [Parse](#parse)
            * [TryParse](#tryparse)
            * [Validando o TryParse](#validando-o-tryparse)
   * [Exceções](#exceções)
      + [Realizando leitura de um arquivo](#realizando-leitura-de-um-arquivo)
      + [Disparando e tratando uma exceção](#disparando-e-tratando-uma-exceção)
      + [Exceção genérica e específica](#exceção-genérica-e-específica)
         - [Genérica](#genérica)
         - [Específica](#específica)
         - [Bloco finally](#bloco-finally)
      + [Exceção Throw](#exceção-throw)
   * [Coleções](#coleções)
      + [Filas](#filas)
      + [Pilhas](#pilhas)
   ...
   * [Tuplas, Operador ternário e Desconstrução de Objeto](#tuplas-operador-ternário-e-desconstrução-de-objeto)
      + [Sintaxe de uma tupla](#sintaxe-de-uma-tupla)
      + [Tuplas em métodos](#tuplas-em-métodos)
      + [Descartes](#descartes)
   ...
   * [Nuget, Serializar e Atributos](#nuget-serializar-e-atributos)
      ...
      + [Serialização](#serialização)
         - [JSON](#json)
         - [Salvando um objeto serializado](#salvando-um-objeto-serializado)
         - [JSON Viewer](#json-viewer)
         - [DateTime em JSON](#datetime-em-json)
         - [Deserializando um objeto](#deserializando-um-objeto)
      + [Atributos](#atributos)
         - [Metadados com Newtonsoft](#metadados-com-newtonsoft)
